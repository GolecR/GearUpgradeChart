...
function GearUpgradeChart:GenerateRewardsTabContent(container)
    ...
    local rows = {
        {level = "1", mPlusEndChest =  {reward = "Champion 1", rgb = GUF_CHAMPION_RGB}, 
                      mPlusVault = {reward = "Champion 4", rgb = GUF_CHAMPION_RGB}, 
                      mPlusCrests = {reward = "10 Champion", rgb = GUF_CHAMPION_RGB},  
                      delveReward = {reward = "Veteran 1", rgb = GUF_VETERAN_RGB}},
        {level = "2", mPlusEndChest =  {reward = "Champion 2", rgb = GUF_CHAMPION_RGB}, 
                      mPlusVault = {reward = "Hero 1", rgb = GUF_HERO_RGB},         
                      mPlusCrests = {reward = "12 Champion", rgb = GUF_CHAMPION_RGB},  
                      delveReward = {reward = "Veteran 2", rgb = GUF_VETERAN_RGB}},
        {level = "3", mPlusEndChest =  {reward = "Champion 2", rgb = GUF_CHAMPION_RGB}, 
                     mPlusVault = {reward = "Hero 1", rgb = GUF_HERO_RGB},         
                     mPlusCrests = {reward = "14 Champion ", rgb = GUF_CHAMPION_RGB}, 
                     delveReward = {reward = "Veteran 3", rgb = GUF_VETERAN_RGB}},
        {level = "4", mPlusEndChest =  {reward = "Champion 3", rgb = GUF_CHAMPION_RGB}, 
                     mPlusVault = {reward = "Hero 2", rgb = GUF_HERO_RGB},         
                     mPlusCrests = {reward = "10 Hero", rgb = GUF_HERO_RGB},  
                     delveReward = {reward = "Veteran 4", rgb = GUF_VETERAN_RGB}},
        {level = "5", mPlusEndChest =  {reward = "Champion 4", rgb = GUF_CHAMPION_RGB}, 
                      mPlusVault = {reward = "Hero 2", rgb = GUF_HERO_RGB},         
                      mPlusCrests = {reward = "12 Hero ", rgb = GUF_HERO_RGB}, 
                      delveReward = {reward = "Champion 1", rgb = GUF_CHAMPION_RGB}},
        {level = "6", mPlusEndChest =  {reward = "Hero 1", rgb = GUF_HERO_RGB},         
                      mPlusVault = {reward = "Hero 3", rgb = GUF_HERO_RGB},         
                      mPlusCrests = {reward = "14 Hero", rgb = GUF_HERO_RGB},  
                      delveReward = {reward = "Champion 3", rgb = GUF_CHAMPION_RGB}},
        {level = "7", mPlusEndChest =  {reward = "Hero 1", rgb = GUF_HERO_RGB},         
                      mPlusVault = {reward = "Hero 4", rgb = GUF_HERO_RGB},         
                      mPlusCrests = {reward = "16 Hero ", rgb = GUF_HERO_RGB}, 
                      delveReward = {reward = "Champion 4", rgb = GUF_CHAMPION_RGB}},
        {level = "8", mPlusEndChest =  {reward = "Hero 2", rgb = GUF_HERO_RGB},         
                      mPlusVault = {reward = "Hero 4", rgb = GUF_HERO_RGB},         
                      mPlusCrests = {reward = "18 Hero", rgb = GUF_HERO_RGB},  
                      delveReward = {reward = "Hero 1", rgb = GUF_HERO_RGB}},
        {level = "9", mPlusEndChest =  {reward = "Hero 2", rgb = GUF_HERO_RGB},         
                      mPlusVault = {reward = "Hero 4", rgb = GUF_HERO_RGB},         
                      mPlusCrests = {reward = "10 Myth ", rgb = GUF_MYTH_RGB}, 
                      delveReward = {reward = "Hero 1", rgb = GUF_HERO_RGB}},
        {level = "10", mPlusEndChest = {reward = "Hero 3", rgb = GUF_HERO_RGB},         
                       mPlusVault = {reward = "Myth 1", rgb = GUF_MYTH_RGB},         
                       mPlusCrests = {reward = "12 Myth", rgb = GUF_MYTH_RGB},  
                       delveReward = {reward = "Hero 1", rgb = GUF_HERO_RGB}},
        {level = "11", mPlusEndChest = {reward = "Hero 3", rgb = GUF_HERO_RGB},         
                       mPlusVault = {reward = "Myth 1", rgb = GUF_MYTH_RGB},         
                       mPlusCrests = {reward = "14 Myth", rgb = GUF_MYTH_RGB},  
                       delveReward = {reward = "Hero 1", rgb = GUF_HERO_RGB}},
        {level = "12", mPlusEndChest = {reward = "Hero 3", rgb = GUF_HERO_RGB},         
                       mPlusVault = {reward = "Myth 1", rgb = GUF_MYTH_RGB},         
                       mPlusCrests = {reward = "16 Myth", rgb = GUF_MYTH_RGB},  
                       delveReward = {reward = "Hero 1", rgb = GUF_HERO_RGB}}
    }
